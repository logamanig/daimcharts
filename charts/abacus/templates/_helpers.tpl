...
{{/*
AbacusConfigMigrations
*/}}
{{/*
Expand the name of the chart.
*/}}
{{- define "abacusConfigMigrations.name" -}}
{{- default "abacusconfigmigrations" .Values.abacusConfigMigrations.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "abacusConfigMigrations.fullname" -}}
{{- if .Values.abacusConfigMigrations.fullnameOverride }}
{{- .Values.abacusConfigMigrations.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default "abacusconfigmigrations" .Values.nameOverride }}
{{- if contains $name .Release.Name }}
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name | trunc 63 | trimSuffix "-" }}
...
Create chart name and version as used by the chart label.
*/}}
{{- define "abacusConfigMigrations.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
...
Common labels
*/}}
{{- define "abacusConfigMigrations.labels" -}}
helm.sh/chart: {{ include "abacusConfigMigrations.chart" . }}
{{ include "abacusConfigMigrations.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "abacusConfigMigrations.selectorLabels" -}}
app.kubernetes.io/name: {{ include "abacusConfigMigrations.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
Create the name of the service account to use
*/}}
{{- define "abacusConfigMigrations.serviceAccountName" -}}
{{- if .Values.abacusConfigMigrations.serviceAccount.create }}
{{- default (include "abacusConfigMigrations.fullname" .) .Values.abacusConfigMigrations.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.abacusConfigMigrations.serviceAccount.name }}
{{- end }}
{{- end }}